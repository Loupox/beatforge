# CI/CD Post-Build - Plan & Implémentation
...
Le script:
1. Incrémente le versionCode dans `app/build.gradle.kts`
2. Build avec Docker: `docker compose run --rm build ./gradlew clean assembleDebug`
3. Déploie sur téléphone si ADB connecté
4. Affiche le résumé: version, build, APK, statut déploiement
