...
val DarkColors = darkColorScheme(
    ...
    surface = BeatForgeColors.BronzeCharbon.surface,
    onSurface = BeatForgeColors.BronzeCharbon.textPrimary,
    surfaceVariant = BeatForgeColors.BronzeCharbon.surface2,
...
val LightColors = lightColorScheme(
    ...
    surface = BeatForgeColors.BoisClair.surface,
    onSurface = BeatForgeColors.BoisClair.textPrimary,
    surfaceVariant = BeatForgeColors.BoisClair.surface2,
